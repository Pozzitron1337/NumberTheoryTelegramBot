    ...
    public void onUpdateReceived(Update update) {
        ...
        if(message!=null && message.hasText()){
            ...
            if(msg[0].equals("modulus")||msg[0].equals("0")){
                ...
                if(a.compareTo(BigInteger.valueOf(999999999))==1||b.compareTo(BigInteger.valueOf(999999999))==1){
                    sendMsg(message,"too large number");
                }
                else {
            ...
            if(msg[0].equals("GornerScheme")||msg[0].equals("1")){
                Pattern gornerscheme=Pattern.compile("^(\\d*)\\^(\\d*)\\s*mod\\s*(\\d*)");
                ...
                if(a.compareTo(BigInteger.valueOf(999999999))==1||b.compareTo(BigInteger.valueOf(999999999))==1||c.compareTo(BigInteger.valueOf(999999999))==1){
                    sendMsg(message,"too large number");
                }
                else {
            ...
            if(msg[0].equals("EulerFunction")||msg[0].equals("4")){
                ...
                if(n.compareTo(BigInteger.valueOf(999999999))==1){
                    sendMsg(message,"too large number");
                }
                else {
            ...
            if(msg[0].equals("SolvingCongruence")||msg[0].equals("8")){
                ...
                if(a.compareTo(BigInteger.valueOf(999999999))==1||b.compareTo(BigInteger.valueOf(999999999))==1||n.compareTo(BigInteger.valueOf(999999999))==1){
                    sendMsg(message,"too large number");
                }
                else {
            ...
            if(msg[0].equals("SolvingSystemOfTwoCongruence")||msg[0].equals("9")){
                ...
                if(x1.compareTo(BigInteger.valueOf(999999999))==1||x2.compareTo(BigInteger.valueOf(999999999))==1||m1.compareTo(BigInteger.valueOf(999999999))==1||m2.compareTo(BigInteger.valueOf(999999999))==1){
                    sendMsg(message,"too large number");
                }
                else {
            ...
            if(msg[0].equals("SymbolJacobi")||msg[0].equals("13")){
                ...
                if(x.compareTo(BigInteger.valueOf(999999999))==1||n.compareTo(BigInteger.valueOf(999999999))==1){
                    sendMsg(message,"too large number");
                }
                else {
            ...
            if(msg[0].equals("Root")||msg[0].equals("14")){
                ...
                rootmatch.find();
                BigInteger a=new BigInteger(rootmatch.group(1));
                BigInteger n=new BigInteger(rootmatch.group(2));
                if(a.compareTo(BigInteger.valueOf(999999999))==1||n.compareTo(BigInteger.valueOf(999999999))==1){
                    sendMsg(message,"too large number");
                }
                else {
                    sendMsg(message,algorithm.SquareRoots_version2(a,n).toString());
                }
            }
